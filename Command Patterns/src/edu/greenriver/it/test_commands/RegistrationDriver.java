...
public class RegistrationDriver {
	...
	public static GRClass[] getClasses() {
		return new GRClass[] { new GRClass("TC 120", 4, "IT 426"), new GRClass("TC 120", 4, "IT 301"),
				new GRClass("KC 309", 4, "IT 333") };
	}

	public static Student[] getStudents() {
		return new Student[] { new Student("Sarah"), new Student("Linda"), new Student("Bob"), new Student("Alex"),
				new Student("Josh") };
	}
